...
const mockdata = [
  {
    icon: Truck,
    title: 'Find the career industry for you',
    description:
      'As electricity builds up inside its body, it becomes more aggressive. One theory is that the electricity.',
  },
  {
    icon: Certificate,
    title: 'Answer questions and find your path',
    description:
      'Slakoth’s heart beats just once a minute. Whatever happens, it is content to loaf around motionless.',
  },
  {
    icon: Coin,
    title: 'Find your personalized path to your dream schools',
    description:
...
export default function FeaturesAsymmetrical() {
  ...
  return (
    <Container mt={30} mb={30} size="lg">
      <SimpleGrid cols={3} breakpoints={[{ maxWidth: 'sm', cols: 1 }]} spacing={150}>
        {items}
      </SimpleGrid>
    </Container>
  );
