...
const useStyles = createStyles((theme) => ({
  ...
  gridContainer: {
    display: 'grid',
    gridTemplateRows: '200px 40px 40px 40px 40px 40px',
    gridTemplateColumns: '210px 150px 150px 150px',
    width: '600px',
  ...
  borderTitle: {
    marginTop: '5px',
    marginBottom: '5px',
    color: theme.colorScheme === 'dark' ? 'white' : '#e0fbfc',
     backgroundColor: theme.colorScheme === 'dark' ? '#0096c7' : '#e63946',
     borderRadius: '2px',
  ...
  border: {
    color: theme.colorScheme === 'dark' ? '#555b6e' : '#555b6e',
    border: `1px solid ${theme.colorScheme === 'dark' ? theme.white :theme.colors.dark[6] }`,
    borderRadius: '10px',
    backgroundColor: theme.colorScheme === 'dark' ? '#cae9ff' : '#e1e5f2',
    margin: '5px',
  },
    ...
    >
      ...
      <PricingBullets />
       <Container className={classes.gridContainer}>
          <Container className={classes.border}> Plans   </Container>
          <Container  className={classes.border}>
            <Text> Individual </Text>
            <Text> Find rveyr </Text>
          </Container>
          <Container className={classes.border}> 
            <Text> School Systems </Text>
             </Container>
          <Text  className={classes.border}> </Text>
          <Text  className={classes.borderTitle}> <b> MyNext4 (open-source) </b> </Text>
          <Text  className={classes.titleBackground} >  </Text>
          <Text  className={classes.titleBackground}> </Text>
          <Text className={classes.borderTitle}>  </Text>
          <Text  className={classes.border}> Course Library  </Text>
          <Text  className={classes.border}> ✅  </Text>
          <Text  className={classes.border}> ✅ </Text>
          <Text  className={classes.border}>  </Text>
          <Text  className={classes.border}> Education Library </Text>
          <Text  className={classes.border}> ✅ </Text>
          <Text  className={classes.border}> ✅</Text>
          <Text  className={classes.border}>  </Text>
          <Text  className={classes.border}> Next Career Library </Text>
          <Text  className={classes.border}> ✅ </Text>
          <Text  className={classes.border}> ✅</Text>
          <Text  className={classes.border}>  </Text>
          <Text  className={classes.borderTitle}> <b> MyNext4+(components)</b> </Text>
          <Text  className={classes.titleBackground}  >  </Text>
          <Text  className={classes.titleBackground}> </Text>
          <Text  className={classes.borderTitle}>  </Text>
          <Text  className={classes.border}> MyCourses  </Text>
          <Text  className={classes.border}>  </Text>
          <Text  className={classes.border}> ✅ </Text>
          <Text  className={classes.border}>  </Text>
          <Text  className={classes.border}> MyColleges  </Text>
          <Text  className={classes.border}>  </Text>
          <Text  className={classes.border}> ✅ </Text>
          <Text  className={classes.border}>  </Text>
          <Text  className={classes.border}> MyCareers  </Text>
          <Text  className={classes.border}>  </Text>
          <Text  className={classes.border}> ✅ </Text>
          <Text  className={classes.border}>  </Text>
          <Text  className={classes.border}> MyAchievments </Text>
          <Text  className={classes.border}>  </Text>
          <Text  className={classes.border}> ✅</Text>
          <Text  className={classes.border}>  </Text>
          <Text  className={classes.borderTitle}> <b> Support </b> </Text>
           
          <Text className={classes.titleBackground}> </Text>
          <Text className={classes.titleBackground} >  </Text>
          <Text className={classes.titleBackground} > </Text>
      
          <Text  className={classes.border}> Community  </Text>
          <Text  className={classes.border}> ✅ </Text>
          <Text className={classes.border}> ✅ </Text>
          <Text  className={classes.border}>  </Text>
          <Text  className={classes.border}> Bug reports & feature requests </Text>
          <Text  className={classes.border}> ✅ </Text>
          <Text  className={classes.border}> ✅ Priority over Individual </Text>
          <Text  className={classes.border}>  </Text>
          <Text  className={classes.border}> Pre-released content </Text>
          <Text   className={classes.border}>  </Text>
          <Text  className={classes.border}>  ✅ </Text>
          <Text  className={classes.border}>  </Text>
        ...
        <FeaturesGrid title="Key information for school systems"  description="" />
