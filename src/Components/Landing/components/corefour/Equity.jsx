...
function Equity() {
  ...
  <p style={{fontSize: '10px', color: 'gray', textAlign: 'center', marginTop: '5px', marginBottom: '15px'}}> We have a mission to make all students have access to the material, information, and top tips that ensures their success.</p>
  </Paper>
