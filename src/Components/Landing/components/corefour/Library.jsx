...
function Library() {
    return (
        ...
        <Card sx={{margin: '0 8em 0 auto',top: '20%', padding: 0, width: '24vw', height: '36em', backgroundImage: "url('https://images.unsplash.com/photo-1644525630215-57f94441da72?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxjb2xsZWN0aW9uLXBhZ2V8MjB8MTM5NDczMnx8ZW58MHx8fHw%3D&auto=format&fit=crop&w=500&q=60')", backgroundSize: 'cover'}} withBorder shadow='lg' radius="md" >   
  ...
  <h4 style={{ fontSize: '20px', textAlign: 'center', marginTop: 10, fontWeight: 400}}> Explore over 2000+ academic cards <span style={{fontWeight: 800}} > free </span>.</h4>
  </Paper>
