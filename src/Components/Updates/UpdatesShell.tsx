...
export default function AppShellExample() {
  ...
  return (
    ...
    >
      <Container mt={70} sx={{ textAlign: "left" }}>
        <Title className={classes.title}> MyNext4 Update Log </Title>
        <Text mb={70}> Chronological update history for MyNext4.</Text>
      </Container>
      <Container
        sx={{ display: "flex", justifyContent: "left", alignItems: "center" }}
      >
        <Text sx={{ paddingRight: 10, fontWeight: 700 }}>
          {" "}
          <i>MyNext4</i>{" "}
        </Text>
        <Code sx={{ fontSize: 13, fontWeight: 700 }}>v1.1.0</Code>
      </Container>
      <Container
        sx={{ display: "flex", justifyContent: "left", alignItems: "center" }}
      >
        <Text sx={{ fontSize: 14, textAlign: "left" }} mt={10} pl={120}>
          {" "}
          Added functional MyNext4 properties to deploy a minimum viable
          product. Base component library became uploaded and fully functional
          on our live MyNext4 site.
        </Text>
      </Container>
    </AppShell>
  );
